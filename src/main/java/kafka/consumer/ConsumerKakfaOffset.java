...
public class ConsumerKakfaOffset {
    public static void main(String[] args) {
        ...
        properties.put("enable.auto.commit", "false");// il se souvient pas  de l offser reprendre epuis le debut
        ...
        try {
            ...
            consumer.close();
          //  consumer.commitAsync(); permet d ecommiter et se souvrenir de l offset
        }
